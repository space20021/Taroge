...
int FFTtree(char* path)
{
    ...
    t1->Branch("ch1",&ch1_Buf,"ch1_Buf[length]/D");
    t1->Branch("ch1_fft",&ch1_fftBuf,"ch1_fftBuf[length]/D");
    ...
    while(true)
    {
        ...
        if (infile.eof())
        {
            ...
            t1->Branch("time",&time,"time/L");
            t1->Branch("length",&length,"length/I");
            t1->Branch("ch1[1]",&ch1_Buf,"ch1_Buf[length]/F");
            t1->Branch("ch1_fft[1]",&ch1_fftBuf,"ch1_fftBuf[length]/F");
        }
